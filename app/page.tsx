        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4 md:space-x-8">
              ...
              >
                {darkMode ? (
                  <svg className="w-5 h-5 text-foreground-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <a href="https://neuronmessaging.com/@polascin" target="_blank" rel="noopener noreferrer" className="text-foreground-2 hover:text-brand transition-colors">Neuuron @polascin</a>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-6 h-6 text-brand mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-center">
                    ...
                    <a href="mailto:lubomir@polascin.net" className="text-foreground-2 hover:text-brand transition-colors">Viber lubomir@polascin.net</a>
                  </div>
                </div>
              </div>
              <div>
