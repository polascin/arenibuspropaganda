          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-surface-2 p-6 rounded-lg shadow-brand hover:shadow-brand-lg transition-shadow border border-border">
              ...
              <p className="text-foreground-2 text-sm leading-relaxed">
                Registrácia (vrátane bezdomovca a cudzinca mimo EÚ) a vyhľadávanie vrátane overenia poisťovne v registri poistencov ÚDZS, identifikačná karta (meno, poisťovňa, adresa, kontakt a krvná skupina) pre role bez klinického oprávnenia, alergie, medikácia, poučenia a súhlasy vrátane paliatívnej starostlivosti (§ 6ba) s náležitosťami sociálnej pomoci, duchovnej služby a postupu pri nedostupnosti v opodstatnenej lehote, spôsobu poučenia (§ 6 ods. 2), poučenej osoby (§ 6 ods. 1) vrátane osoby určenej pacientom (§ 6 ods. 1 písm. a) a zástupcu osoby (§ 6 ods. 1 písm. b), odmietnutia poučenia (§ 6 ods. 3), vyjadrenia nespôsobilej osoby (§ 6 ods. 10), negatívneho reverzu a situácií, keď sa súhlas nevyžaduje (§ 6 ods. 9), súhlasov na HD, PD, CVK, AV fistulu, transfúziu a biopsiu obličky, poučenia o rozsahu a podmienkach starostlivosti a o zmluve s poisťovňou (§ 79 ods. 1 písm. h) aj účasti na výučbe (§ 11 ods. 9), dohoda o poskytovaní ZS — právny vzťah vzniká dohodou (§ 12 ods. 1), do registra dohôd NCZI sa nezapisuje (§ 12 ods. 2; vyhradené všeobecnej a primárnej gynekologickej starostlivosti) a neuzatvára sa pri výlučne neodkladnej starostlivosti (§ 12 ods. 3) — vrátane odstúpenia osoby aj poskytovateľa (§ 12 ods. 16) s písomným upovedomením (§ 12 ods. 17) a zániku dohody pri úmrtí alebo zániku poskytovateľa (§ 12 ods. 18) aj dôvodov odstúpenia poskytovateľa (§ 12 ods. 9) vrátane osobného presvedčenia (§ 12 ods. 11: len UPT, sterilizácia, asistovaná reprodukcia), očkovania s individuálnym plánom (§ 9 ods. 7) so znením základného ochorenia, imunosupresie a imunitného profilu a so zachovaním predchádzajúceho znenia, záverom lekára pred očkovaním (§ 13 ods. 2), pri profesionálnom očkovaní prečiarknutím „hradí poisťovňa“ (§ 13 ods. 1 vyhl. 585/2008), prekážkami, nežiaducimi účinkami, rozhodnutiami RÚVZ vrátane rozhodnutia, na ktorého základe sa očkovalo (§ 17 ods. 2), a oznámením zmluvnému lekárovi (§ 13 ods. 5), posudky so súhlasom osoby (§ 16 ods. 3), pracovná neschopnosť, ktorú posudzuje aj lekár špecializovanej ambulantnej starostlivosti (§ 12a ods. 1 písm. c), vrátane liečebného režimu (§ 12a ods. 3, § 2 ods. 11), vychádzok aj ich zrušenia zo závažných dôvodov (§ 12a ods. 7), preukazu o trvaní (§ 12a ods. 8), pokračovania predošlej PN (§ 12a ods. 10), ukončenia lekárom najviac tri dni spätne a vyšetrenia najneskôr v deň predpokladaného skončenia (§ 12a ods. 5) alebo pre nedostavenie sa (§ 12a ods. 6), potvrdenia pri výpadku IS (§ 12a ods. 17) a starostlivosti poskytnutej zamestnancovi po odpracovaní zmeny (§ 12a ods. 4) a osobná starostlivosť (§ 12b) vrátane dôvodu potreby (§ 12b ods. 2), písomného nesúhlasu, hospitalizácie, ktorá potrebu neukončuje (§ 12b ods. 9), spôsobu ukončenia (§ 12b ods. 8), upovedomenia všeobecného lekára osoby (§ 12b ods. 3 písm. c), oznámenia všeobecnému lekárovi a papierového potvrdenia pri výpadku NZIS (§ 12b ods. 11), lekárske predpisy a poukazy vrátane listinného predpisu z číselníka ŠÚKL do napojenia na eRecept (§ 79 ods. 1 písm. r), čakacia listina so súhlasom podľa zák. 317/2016 a písomným odporúčaním nefrológa transplantačného centra a návrh transplantácie pred dialýzou (§ 79 ods. 1 písm. ad) vrátane poučenia o živom darcovi a hlásenia pre NTO, hlásenia prenosných ochorení s dokladom o hlásení RÚVZ (§ 4 vyhl. 585/2008), zamestnaním alebo povolaním (§ 20 ods. 2 písm. e) vyhl. 585/2008), zdrojom nákazy (§ 11 ods. 14) a okruhom osôb, na ktoré mohla chorobu preniesť, oznámenia podozrenia z týrania, zanedbávania, zneužívania, znásilnenia, sexuálneho násilia a súlože medzi príbuznými (§ 79 ods. 4) orgánu činnému v trestnom konaní, obci alebo UPSVaR, lekárske ožiarenia s odôvodnením indikácie (§ 44a ods. 1), predchádzajúcimi ožiareniami (§ 44a ods. 2 písm. b), zistením u ženy v reprodukčnom veku (§ 44a ods. 2 písm. e) a údajom o dávke (§ 44d), preprava dopravnou zdravotnou službou vrátane asistencie alebo sprievodu (§ 14 ods. 1 písm. a) zák. 576/2004) a oslobodenia od spoluúčasti za 1 km (§ 3 ods. 19 zák. 577/2004), biomedicínsky výskum vrátane schválenia (§ 26 ods. 5 až 7), povahy so zdravotnou indikáciou aj bez nej (§ 26 ods. 8 a 9), písomného informovaného súhlasu po poučení (§ 27 ods. 2 písm. a) až k) s možnosťou odvolania a písomného informovania poisťovne (§ 26 ods. 11), sprístupňovanie dokumentácie so zákazmi nahliadnutia, registrom nahliadnutí (§ 25) vrátane okruhu manžel/dieťa/rodič (§ 25 ods. 1 písm. b a d), inšpektora správnej klinickej praxe (§ 25 ods. 1 písm. t, len pseudonymizované kópie), výpiskov a kópií (§ 25 ods. 2), pseudonymizácie, osvedčeného podpisu (§ 18 ods. 4) a kontroly 7-dňovej platnosti potvrdenia všeobecného lekára (§ 25 ods. 8), výpis podľa právneho základu všeobecného alebo odporúčajúceho lekára (§ 24 ods. 3) alebo písomného vyžiadania oprávnenej osoby (§ 24 ods. 4) a súpis dokumentácie, zbavenie mlčanlivosti (§ 80 ods. 3 až 6), žiadosti o nápravu osobou alebo blízkou osobou (§ 17 ods. 1 a 2) vrátane dôvodu správnosti poskytnutia (§ 4 ods. 3) a písomného informovania o spôsobe vybavenia do 30 dní (§ 17 ods. 3), žiadosti Sociálnej poisťovne s výpisom a zhodnotením liečby do ôsmich dní (§ 233 ods. 2 písm. a) zák. 461/2003), potvrdenie ambulantnej starostlivosti (§ 19 ods. 2 písm. f), evidencia úmrtia a uchovávanie dokumentácie s evidenciou lehôt vrátane 30 rokov pri dokumentácii súvisiacej s transplantáciou a záznamu o naložení s dokumentáciou.
              </p>
            </div>
            ...
            <div className="bg-surface-2 p-6 rounded-lg shadow-brand hover:shadow-brand-lg transition-shadow border border-border">
              ...
              <p className="text-foreground-2 text-sm leading-relaxed">
                Klinické zápisy (SOAP) so vzormi textov, antropometria (výška, hmotnosť, BMI podľa WHO, BSA Mosteller a DuBois, obvod pása, viscerálny tuk, suchá hmotnosť, IBW a LBW), vlastné typy návštev, klasifikácia CKD (KDIGO 2024 CGA) vrátane potvrdenia chronicity abnormalít (≥ 3 mesiace), uACR a odporúčania eGFRcr-cys (cystatín C), epikríza, dispenzarizácia vrátane skupiny podľa vyhl. 127/2014, výkony (eZápis) a pripočítateľné položky s kontrolou revíznych pravidiel, lehota plánovanej starostlivosti (§ 21 ods. 3 písm. h), lekárske správy s evidenciou doručenia vrátane správy pre všeobecného alebo odporúčajúceho lekára (§ 8 ods. 6), odporúčania na ďalšiu špecializovanú starostlivosť a SVLZ s náležitosťami (§ 8 ods. 4 a 8) vrátane dôvodu, prečo sa odporúčanie nevyžaduje (§ 8 ods. 5), a konzultácie medzi pracovníkmi vrátane telekonzultácie a videokonzultácie ako samostatnej formy starostlivosti (§ 2 ods. 46 písm. b) a § 7 ods. 1 písm. f), overenie poistného vzťahu (ÚDZS), vzdialená starostlivosť vrátane telekonzultácie a videokonzultácie s overením totožnosti a poistného vzťahu (§ 8 ods. 13), miesto poskytnutia (§ 8 ods. 1) vrátane domáceho a iného prirodzeného prostredia, domáca starostlivosť na žiadosť osoby mimo ordinačných hodín (§ 8 ods. 10) a doplnkové ordinačné hodiny (§ 2a ods. 3) — uhrádza osoba podľa cenníka a nevykazujú sa poisťovni, vyšetrenie na sociálne účely (Sociálna poisťovňa, ÚPSVaR), poskytnutie počas krízovej situácie (§ 49k), zápis osobou určenou podľa § 18 ods. 1 (§ 21 ods. 3 písm. i), výpis záznamu návštevy podľa § 21 a oprava zápisu so zachovaním pôvodného znenia.
              </p>
            </div>
            ...
            <div className="bg-surface-2 p-6 rounded-lg shadow-brand hover:shadow-brand-lg transition-shadow border border-border">
              ...
              <p className="text-foreground-2 text-sm leading-relaxed">
                Program PD (CAPD a APD), predpisy, vyšetrenie PD, záznamy výmen, cyklovač, použité roztoky vrátane ikodextrínu a aminokyselinového roztoku, PET a Kt/V vrátane reziduálneho renálneho Kt/V, reziduálna diuréza, peritoneálny katéter (typ a dátum zavedenia), bilancia tekutín, ošetrovanie exit-site, liečba peritonitídy a komplikácií, zaškolenie pacienta, zaradenie do programu a zrušenie záznamu s nahradením.
              </p>
            </div>
            ...
            <div className="bg-surface-2 p-6 rounded-lg shadow-brand hover:shadow-brand-lg transition-shadow border border-border">
              ...
              <p className="text-foreground-2 text-sm leading-relaxed">
                Kalendár ambulancie a dialyzačných smien, dnešné termíny, čakajúce ošetrenia, denný rozpis, správa objednávok (osobne, telefonicky, národný objednávací systém NCZI aj objednávací systém poskytovateľa) vrátane dňa objednania a lehoty 20 dní (§ 2a ods. 2), evidencia nedostavenia sa (neprišiel) a súhrn na odovzdanie služby.
              </p>
            </div>
            ...
            <div className="bg-surface-2 p-6 rounded-lg shadow-brand hover:shadow-brand-lg transition-shadow border border-border">
              ...
              <p className="text-foreground-2 text-sm leading-relaxed">
                Vlastné zoznamy diagnóz a výkonov, denný súhrn ambulancie a dialýzy, evidencie vyžiadanej dokumentácie s odovzdaním do siedmich dní (§ 23 ods. 3), pracovných neschopností, žiadostí o nápravu s písomným informovaním o spôsobe vybavenia do 30 dní (§ 17 ods. 3) a nevybavených žiadaniek na SVLZ, kniha eliminačných výkonov s evidenciou napojenia, prehľad lehôt uchovávania dokumentácie vrátane 20 rokov od posledného poskytnutia (§ 22) a 30 rokov pri dokumentácii súvisiacej s transplantáciou a záznamu o naložení, indikátory kvality (§ 79 ods. 1 písm. t, § 79a ods. 1 písm. b), objednania a lehota poskytnutia vrátane pôvodu objednania, dňa objednania a počtu dní (§ 2a ods. 2, § 79 ods. 1 písm. am) až ao), podklady pre revíznu kontrolu poisťovne, dozor orgánu a klinický audit (§ 9c ods. 1 písm. d, § 79 ods. 1 písm. q, § 79a ods. 1 písm. d) vrátane podkladov ku kontrole očkovania RÚVZ (§ 14 ods. 1 vyhl. 585/2008) a tlač registrov.
              </p>
            </div>
            ...
            <div className="bg-surface-2 p-6 rounded-lg shadow-brand hover:shadow-brand-lg transition-shadow border border-border">
              ...
              <p className="text-foreground-2 text-sm leading-relaxed">
                Dávky 751a (ambulancia a dialyzačný stacionár) s pre-flight kontrolou pred uzavretím a 799a, dispenzárne dávky, reklamácie dávok vrátane opravnej dávky O a revíznych nálezov, eFaktúra UBL 2.1 / EN 16931 s prenosom čísla faktúry do poľa 7 záhlavia dávky, cenník výkonov, doklady o výške úhrady z cenníka platného v deň úhrady (§ 79 ods. 1 písm. o a g), oslobodenie zdravotnej starostlivosti od DPH (§ 29 zák. 222/2004), služby súvisiace so starostlivosťou vrátane výpisu dokumentácie (§ 13 písm. f), posudku (§ 13 písm. e) a spracúvania údajov pre poistenie (§ 13 písm. c), oznámenia o platenej starostlivosti v doplnkových hodinách (§ 2a), na vlastnú žiadosť a domácej na žiadosť osoby (§ 8 ods. 10, § 79 ods. 1 písm. ap) — vyšetrenie na vlastnú žiadosť a na sociálne účely sa poisťovni nevykazuje — a poučenia o úhrade podľa cenníka (§ 19 ods. 7), potvrdenie neodkladnej starostlivosti vrátane žiadosti poisťovni, či išlo o neodkladnú starostlivosť (§ 79a ods. 1 písm. a a ods. 2), poistenci EÚ aj mimo EÚ vrátane stropu úhrady ako u poistenca SR (§ 79b ods. 4), poistenci bez verejného poistenia (I/J/K) vrátane dokladu totožnosti (§ 79b), lieky a pomôcky podľa pôvodu (§ 79a ods. 1 písm. e) vrátane odchýlok pri podaní z vlastných zásob, oznámenia poisťovni (režim, alkohol, úrazy a kódy náhrady 01 až 04 alebo 06) k poslednému dňu mesiaca (§ 79a ods. 1 písm. c) vrátane odpovede poisťovne, údaje pre ministerstvo zdravotníctva za kalendárny rok v elektronickej podobe (§ 79 ods. 1 písm. zh) a mesačný výkaz pre Sociálnu poisťovňu do 14. dňa nasledujúceho mesiaca (§ 233 ods. 2 písm. c).
              </p>
            </div>
            ...
            <div className="bg-surface-2 p-6 rounded-lg shadow-brand hover:shadow-brand-lg transition-shadow border border-border">
              ...
              <p className="text-foreground-2 text-sm leading-relaxed">
                Dialyzačné zmeny, miestnosti a pozície s evidenciou obsadenosti vrátane izolačnej miestnosti a akútnej dialyzačnej sály, týždenný rozpis personálu, zoznam pracovníkov vrátane úväzku do záhlavia dávky a oznámení kódov a registrácie kraju do 14 dní (§ 79 ods. 18), registrácie v komore vrátane čísla, dátumov registrácie, pozastavenia, obnovenia a zrušenia a ročného poplatku do 31. januára (§ 80 ods. 1 písm. c a d, § 63 a § 64), zdravotníckeho povolania (§ 27), identifikátora NRZP s dňom oznámenia pracovníkovi (§ 79 ods. 1 písm. zm), osoby určenej podľa § 18 ods. 1, preukazu ePZP (aktívny, stratený, odcudzený, zničený, nahradený) s oznámením národnému centru (§ 80 ods. 1 písm. h) a exportu lekárov, sestier a praktických sestier do 65 rokov na vyžiadanie kraja (§ 79 ods. 1 písm. bh), očkovania s kategóriou podľa § 5 ods. 1 vyhl. 585/2008, kvalifikácie zapísané presne podľa dokladu vrátane diplomu o odbornej spôsobilosti (§ 33), uznania dokladu zo zahraničia (§ 35 až 37a), lekárskeho posudku o zdravotnej spôsobilosti (§ 32), bezúhonnosti (§ 38) a starších tvarov (§ 79 ods. 15, § 83c ods. 8, § 83d ods. 1) a sústavné vzdelávanie s evidenciou aktivít a hodnotení komory doručených zamestnávateľovi (§ 42, § 42 ods. 7, § 80 ods. 1 písm. b) — kredity sa nesčítavajú do záveru o splnení, register epidemiologicky závažných skutočností a nežiaducich udalostí vrátane interného systému hodnotenia bezpečnosti pacienta, ktorý môže nahlásiť každý pracovník aj anonymne (§ 79 ods. 1 písm. ba/bb, § 9b), druhu podľa § 9b ods. 2 a prijatých opatrení (§ 9b ods. 3), zmluvy s poisťovňami s evidenciou na viditeľnom mieste (§ 79 ods. 1 písm. f), kniha prehliadok mŕtvych podľa rozpisu úradu pre dohľad vrátane vykonaných prehliadok a ospravedlnení (§ 79 ods. 1 písm. w), písomná forma dokumentácie (§ 20 ods. 2) pri výpadku IS poskytovateľa alebo NZIS, keď to vyžaduje zákon, alebo pri záznamoch nad rámec EZK, písomne dokumentovaný systém kvality (§ 9 ods. 1 a 2) vrátane preukázateľného oboznámenia pracovníkov, evidencia záložných kópií (§ 20 ods. 5), klinické audity vrátane podrobenia sa auditu (§ 79 ods. 1 písm. bc, § 9d), rozpis ordinačných a doplnkových ordinačných hodín ako dvoch odlišných úsekov (§ 2 ods. 32 a 33) so schválením každej zmeny kraja a informovaním o schválení (§ 79 ods. 1 písm. z a bv) a stropom doplnkových hodín na 30 % schválených ordinačných hodín za týždeň, identifikácia poskytovateľa (§ 19 ods. 1 písm. b) vrátane kódu KPZS, identifikátora ZZ (IdZZ) a kódu útvaru PZS, karta zariadenia vrátane náhradného odborného zástupcu pri právnickej osobe (§ 79 ods. 1 písm. e) a druhu zariadenia (§ 7 ods. 3), sprievodca uvedením pracoviska do prevádzky, vykazovacie jednotky a personálne zabezpečenie, označenie zariadenia, informačný list a informácie na webové sídlo o možnostiach ošetrenia, dostupnosti, kvalite, bezpečnosti a cenách (§ 79 ods. 1 písm. zj), poistenie zodpovednosti za škodu po celý čas oprávnenia (§ 79 ods. 1 písm. s) s evidenciou poistnej sumy, oznámenia zmien údajov v povolení bezodkladne (§ 79 ods. 11, § 16, § 17 a § 17e), oznamy o zastupovaní, pozastavení a skončení (§ 79 ods. 1 písm. j) a k) a protokoly odovzdania dokumentácie vrátane odovzdania jednotlivému pacientovi (§ 23 ods. 3), priameho odovzdania inému poskytovateľovi (§ 23 ods. 9) a úschovy samosprávnym krajom (§ 23 ods. 4 a 5).
              </p>
            </div>
