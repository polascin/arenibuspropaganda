          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-surface-2 p-6 rounded-lg shadow-brand hover:shadow-brand-lg transition-shadow border border-border">
              ...
              <p className="text-foreground-2 text-sm leading-relaxed">
                Registrácia a vyhľadávanie, alergie, medikácia, poučenia a súhlasy vrátane paliatívnej starostlivosti (§ 6ba), spôsobu poučenia (§ 6 ods. 2), odmietnutia poučenia (§ 6 ods. 3), vyjadrenia nespôsobilej osoby (§ 6 ods. 10), negatívneho reverzu a situácií, keď sa súhlas nevyžaduje (§ 6 ods. 9), súhlasov na HD, PD, CVK, AV fistulu, transfúziu a biopsiu obličky, rozsahu starostlivosti a zmluvy s poisťovňou aj účasti na výučbe (§ 11 ods. 9), dohoda o poskytovaní ZS vrátane odstúpenia osoby aj poskytovateľa (§ 12 ods. 16) a zániku dohody pri úmrtí alebo zániku poskytovateľa (§ 12 ods. 18), očkovania s individuálnym plánom so zachovaním predchádzajúceho znenia, prekážkami, nežiaducimi účinkami, rozhodnutiami RÚVZ a informovaním zmluvného lekára, posudky, pracovná neschopnosť vrátane liečebného režimu, vychádzok, preukazu o trvaní (§ 12a ods. 8), ukončenia lekárom najviac tri dni spätne (§ 12a ods. 5), potvrdenia pri výpadku IS (§ 12a ods. 17) a starostlivosti poskytnutej zamestnancovi po odpracovaní zmeny (§ 12a ods. 4) a osobná starostlivosť (§ 12b) vrátane písomného nesúhlasu, hospitalizácie, spôsobu ukončenia (§ 12b ods. 8) a papierového potvrdenia pri výpadku NZIS (§ 12b ods. 11), lekárske predpisy a poukazy vrátane listinného predpisu z číselníka ŠÚKL do napojenia na eRecept (§ 79 ods. 1 písm. r), čakacia listina a návrh transplantácie pred dialýzou (§ 79 ods. 1 písm. ad) vrátane poučenia o živom darcovi a hlásenia pre NTO, hlásenia prenosných ochorení s dokladom o hlásení RÚVZ (§ 4 vyhl. 585/2008) a zdrojom nákazy (§ 11 ods. 14) a oznámenia podozrenia (§ 79 ods. 4), lekárske ožiarenia s odôvodnením indikácie (§ 44a) a údajom o dávke (§ 44d), preprava vrátane oslobodenia od spoluúčasti za 1 km (§ 3 ods. 19 zák. 577/2004), biomedicínsky výskum, sprístupňovanie dokumentácie so zákazmi nahliadnutia, registrom nahliadnutí (§ 25) vrátane výpiskov, kópií, pseudonymizácie, osvedčeného podpisu (§ 18 ods. 4) a kontroly 7-dňovej platnosti potvrdenia všeobecného lekára (§ 25 ods. 8), výpis (§ 24) a súpis dokumentácie, zbavenie mlčanlivosti, žiadosti o nápravu, žiadosti Sociálnej poisťovne a evidencia úmrtia s naložením s dokumentáciou.
              </p>
            </div>
            ...
            <div className="bg-surface-2 p-6 rounded-lg shadow-brand hover:shadow-brand-lg transition-shadow border border-border">
              ...
              <p className="text-foreground-2 text-sm leading-relaxed">
                Vlastné zoznamy diagnóz a výkonov, denný súhrn ambulancie a dialýzy, evidencie vyžiadanej dokumentácie, pracovných neschopností, žiadostí o nápravu a nevybavených žiadaniek na SVLZ, kniha eliminačných výkonov s evidenciou napojenia, indikátory kvality, objednania a lehota poskytnutia vrátane pôvodu objednania, dňa objednania a počtu dní (§ 2a ods. 2, § 79 ods. 1 písm. am) až ao), podklady pre revíznu kontrolu poisťovne, dozor orgánu a klinický audit (§ 9c) vrátane podkladov ku kontrole očkovania RÚVZ (§ 14 ods. 1 vyhl. 585/2008) a tlač registrov.
              </p>
            </div>
            ...
            <div className="bg-surface-2 p-6 rounded-lg shadow-brand hover:shadow-brand-lg transition-shadow border border-border">
              ...
              <p className="text-foreground-2 text-sm leading-relaxed">
                Dávky 751a (ambulancia a dialyzačný stacionár) s pre-flight kontrolou pred uzavretím a 799a, dispenzárne dávky, reklamácie dávok vrátane opravnej dávky O a revíznych nálezov, eFaktúra UBL 2.1, cenník výkonov, doklady o úhrade, služby súvisiace so starostlivosťou, oznámenia o platenej starostlivosti vrátane starostlivosti v doplnkových hodinách a domácej na žiadosť osoby (§ 79 ods. 1 písm. ap) a poučenia o úhrade podľa cenníka (§ 19 ods. 7), potvrdenie neodkladnej starostlivosti, poistenci EÚ aj mimo EÚ, poistenci bez verejného poistenia (I/J/K) vrátane dokladu totožnosti (§ 79b), lieky a pomôcky podľa pôvodu (§ 79a) vrátane odchýlok pri podaní z vlastných zásob, oznámenia poisťovni (režim, alkohol, úrazy a kódy náhrady) vrátane odpovede poisťovne, údaje pre ministerstvo zdravotníctva (§ 79 ods. 1 písm. zh) a mesačný výkaz pre Sociálnu poisťovňu (§ 233 ods. 2 písm. c).
              </p>
            </div>
            ...
            <div className="bg-surface-2 p-6 rounded-lg shadow-brand hover:shadow-brand-lg transition-shadow border border-border">
              ...
              <p className="text-foreground-2 text-sm leading-relaxed">
                Dialyzačné zmeny a miestnosti, týždenný rozpis personálu, zoznam pracovníkov vrátane oznámení, registrácie v komore, identifikátora NRZP, osoby určenej podľa § 18 ods. 1, preukazu ePZP s oznámením národnému centru (§ 80 ods. 1 písm. h) a exportu pracovníkov do 65 rokov na vyžiadanie kraja (§ 79 ods. 1 písm. bh), očkovania, kvalifikácie a sústavné vzdelávanie, register epidemiologicky závažných skutočností a nežiaducich udalostí vrátane interného systému hodnotenia bezpečnosti pacienta (§ 79 ods. 1 písm. ba/bb, § 9b), zmluvy s poisťovňami, kniha prehliadok mŕtvych, písomná forma dokumentácie, dokumenty systému kvality vrátane preukázateľného oboznámenia pracovníkov, evidencia záložných kópií, klinické audity vrátane podrobenia sa auditu (§ 79 ods. 1 písm. bc, § 9d), rozpis ordinačných hodín s predložením kraju, karta zariadenia vrátane náhradného odborného zástupcu, vykazovacie jednotky a personálne zabezpečenie, označenie zariadenia, informačný list a informácie na webové sídlo o možnostiach ošetrenia, kvalite, bezpečnosti a cenách (§ 79 ods. 1 písm. zj), poistenie zodpovednosti za škodu, oznámenia zmien údajov v povolení, oznamy o zastupovaní a protokoly odovzdania dokumentácie vrátane priameho odovzdania inému poskytovateľovi (§ 23 ods. 9) a úschovy samosprávnym krajom (§ 23 ods. 4 a 5).
              </p>
            </div>
